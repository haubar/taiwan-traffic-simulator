...
/** @typedef {{id:string,operator:Operator,lineId:string,trainType:'LOCAL'|'EXPRESS',direction:0|1,fromStation:string,toStation:string,departureSec:number,arrivalSec:number,source:SourceType}} TrainSchedule */
