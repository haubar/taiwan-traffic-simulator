export const lines = [
  {
    ...
    ].map((s,i,a)=>({id:s[0],name:s[1],x:60+i*(1120/(a.length-1)),y:110}))
  },
  {
    ...
    ].map((s,i,a)=>({id:s[0],name:s[1],x:60+i*(1120/(a.length-1)),y:290}))
  },
  {
    ...
    ].map((s,i,a)=>({id:s[0],name:s[1],x:60+i*(1120/(a.length-1)),y:470}))
  }
]
